        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="lg:w-1/3 flex flex-col gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    {{-- BAGIAN TANGGAL YANG DIPERBARUI --}}
                    <div>
                        <label for="date" class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Publikasi</label>
                        <input type="date" id="date" name="date" value="{{ old('date', $gallery->created_at->format('Y-m-d')) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-coffee-primary/20 focus:border-coffee-primary outline-none transition text-gray-600">
                        @error('date')
                            <p class="text-red-500 text-xs mt-1.5 font-semibold">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <label class="relative flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition group">
                        <input type="radio" name="status" value="draft" class="w-4 h-4 text-gray-400 border-gray-300 focus:ring-gray-400" disabled>
                        <div class="ml-3 flex flex-col">
                            <span class="text-sm font-bold text-gray-400">Simpan sebagai Draft</span>
                        </div>
                    </label>
                </div>
